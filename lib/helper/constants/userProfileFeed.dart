        ...
        if (filterPostByType == true)
          Expanded(
            child: ListView.builder(
              shrinkWrap: true,
              itemCount: userProfileController.myPosts.length,
              // physics: NeverScrollableScrollPhysics(),
              itemBuilder: (BuildContext context, index) {
                final post = userProfileController.myPosts[index];
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  userProfileController.togglePostExpansion(post);
                                  setState(() {});
                                },
                                child: post.expended==false? CustomTextWidget(text: "Expanded"):CustomTextWidget(text: "View Short"),
                              ),
