        ...
        children: [
          ...
          width: Get.width,
            ...
            child:Row(
              ...
              children: [
                CustomTextWidget(text: type, textColor: ColorAssets.white,fontSize: 15,textAlign: TextAlign.center,),
                CustomTextWidget(text: "#"+rank.toString(),textColor: ColorAssets.white,fontSize: 15,textAlign: TextAlign.center,)
              ],
            ),
          ),
          Padding(
